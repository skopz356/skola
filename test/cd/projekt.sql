...
INSERT INTO `kategorie` VALUES (1,'Cusbus'),(2,'Cusbus');
...
CREATE TABLE `prispevky` (
  ...
  PRIMARY KEY (`id`),
  KEY `kategorieid` (`kat_id`),
  CONSTRAINT `kategorieid` FOREIGN KEY (`kat_id`) REFERENCES `kategorie` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `prispevky` VALUES (1,'titulek','obsah',1),(2,'adsfads','dsafasdf',1);
...
-- Dump completed on 2018-10-11 23:17:35
