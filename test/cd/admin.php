...
<form method="post" id="form">
        ...
        if(isset($_SESSION["login"])){
            if($_SESSION["login"] == TRUE){
                ...
                $sql_cat = "SELECT id, name FROM interpreti";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        for($d = 0; $d < count($result_array); $d++){
                            echo '<option value="'.$result_array[$d]["id"].'"'.(($result_array[$d]["id"] == $row["inter_id"] )?'selected="selected"':"").'>'.$result_array[$d]["title"]."</option>";                            
                        }
                        echo "</select>";
            ...
            <form class='add-form' id="add-form-cat">
                ...
                <input type="submit" value="Přidat interpreti">
            </form>
            <!--<select>-->
            <?php 
            /*
